                        ...
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-md-5 col-sm-4">
                                    <img src="{{ asset('frontend/images/banner-bottom1.png') }}"
                                ...
                                <div class="col-md-7 col-sm-8 position-relative">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit
                                            Vestibulum nec purus eu nisl vehicula fringilla.</h5>
                                        <p class="card-text">Integer maximus tortor non ullamcorper dictum. Aenean nec metus
                                            nec tortor laoreet pellentesque vitae et arcu. Morbi varius, eros a finibus
                                            fermentum, quam sem semper erat, vitae posuere felis magna sed urna. Quisque
                                            varius tempus nunc, vitae volutpat nisi faucibus ac. Donec eu erat a leo posuere
                                            facilisis</p>
                                        <a class="text-primary" href="#">Know More <i
                ...
                <div class="col-md-6">
                    <div class="feat-bx">
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-md-5 col-sm-4">
                                    <img src="{{ asset('frontend/images/banner-bottom2.png') }}"
                                        class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-7 col-sm-8 position-relative">
                                    <p class="feat-tag">FEATURED</p>
    ...
    <section class="category-sec">
        <div class="container">
            <div class="main-heading main-view">
                <h2>Campaign</h2>
                <a href="#" class="text-primary">View All Campaign <i class="fa fa-arrow-right"></i></a>
            </div>
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <span>
                                        @php
                                            ...
                                            foreach ($words as $word) {
                                                $initials .= strtoupper(ucwords($word[0]));
                                            }
                                        @endphp

                                        {{ $initials }}
                                    </span> By {{ ucwords($campaign->created_by) }}
                                </p>
                                <div class="price-raise"><strong><i class="fa fa-inr"></i> 0</strong> raised out of
                                    {{ $campaign->price }}</div>
                                ...
                                <ul class="tag-list">
                                    <li class="tag"><i class="fa fa-clock-o"></i>
                                        {{ now()->diffInDays($campaign->end_at) }} days left</li>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button switch1" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <ol>
                                        ...
                                        <li>Donatekart delivers the products and the organisation updates about product
                                            utilization.</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button switch2 collapsed" type="button"
                ...
                <div class="col-md-6">
                    <div class="vid-switches">
                        ...
                        <video id="show2" width="320" height="240" poster="images/vid1.png" controls
                            style="display: none;">
                            <source src="images/herd_of_cows (1080p).mp4" type="video/mp4">
                        </video>
