            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Testimonial</a></li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.testimonial.create')}}" class="btn btn-sm btn-primary"><i
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>{{$i++}}</td>
                                        ...
                                        <td>{!! Str::limit(strip_tags($testimonial->feedback), 20) !!}</td>
                                        <td>
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" data-id="{{$testimonial->id}}"
                                                    data-url="{{ route('admin.testimonial.status', $testimonial->id) }}" {{($testimonial->status == 1)? 'checked' : ''}}
                                                    class="update-status custom-control-input" id="customSwitch{{$testimonial->id}}">
